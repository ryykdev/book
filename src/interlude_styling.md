...
In order for leptos to know what CSS files to bundle with the app, define them in your index.html in the `<head>` as `<link data-trunk rel="css" href="./style.css" />`.
