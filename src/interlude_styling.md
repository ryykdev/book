...
== I tried to use  <Stylesheet href="/style.css" and tried ".style.css" too /> and I couldn't get my style.css inside the root dir to load - it was in the <head> but the sheet probably wasn't bundled. I'm more of an mobile app dev so my web background is quite weak but this tripped me up for too long. Now I just copied some code I found from the examples into my index.html (in the head:  <link data-trunk rel="css" href="./style.css"/> which did the trick but wasn't the solution I was looking for. Maybe it's just my ignorance but I'd like to have had guidance on the simple use cases like to just link a stylesheet here in this section.. ==
